...
//
// namespace Unity.RenderPipelines.Universal.Runtime
// {
//     /// <summary>
...
//         public RenderObjectsPass2(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags,
...
//         }
//
//         internal RenderObjectsPass2(URPProfileId profileId, RenderPassEvent renderPassEvent, string[] shaderTags,
//             RenderQueueType renderQueueType, int layerMask, RenderObjects.CustomCameraSettings cameraSettings)
...
//                     else
//                     {
//                         Matrix4x4 projectionMatrix = Matrix4x4.Perspective(m_CameraSettings.cameraFieldOfView,
//                             cameraAspect,
...
//                 {
//                     activeDebugHandler.DrawWithDebugRenderState(context, cmd, ref renderingData, ref drawingSettings,
//                         ref m_FilteringSettings, ref m_RenderStateBlock,
//                         (ScriptableRenderContext ctx, ref RenderingData data, ref DrawingSettings ds,
//                             ref FilteringSettings fs, ref RenderStateBlock rsb) =>
//                         {
...
//
//             using (var builder =
//                    renderGraph.AddRenderPass<PassData>("Render Objects Pass", out var passData, m_ProfilingSampler))
//             {
