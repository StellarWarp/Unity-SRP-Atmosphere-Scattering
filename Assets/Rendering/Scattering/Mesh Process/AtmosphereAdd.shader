Shader "RayMarching/AtmosphereAdd"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float2 atmo_near_far = RaySphereIntersection(origin, dir, _atmo_radius);
                atmo_near_far.y = min(atmo_near_far.y, distance);

                // if the ray did not hit the atmosphere, return a back color
                if (atmo_near_far.x > atmo_near_far.y)
                    return o;
                ...
                float step_size_i = (atmo_near_far.y - atmo_near_far.x) / float(_steps_i);
                ...
                float ray_pos_i = atmo_near_far.x + dither_i;
                ...
                bool allow_mie = distance > atmo_near_far.y;
                ...
                half alpha = (opacity.x + opacity.y + opacity.z)/3;
